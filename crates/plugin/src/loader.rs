...
use crate::manager::get_plugin_manager;
use crate::manifest::{ManifestParser, PluginManifest};
...
impl PluginLoader {
    ...
    pub async fn activate_plugin(&self, plugin_id: &str) -> Result<(), CoreError> {
        ...
        // 触发激活事件
        crate::events::emit_plugin_activated(plugin_id);
    ...
    pub async fn deactivate_plugin(&self, plugin_id: &str) -> Result<(), CoreError> {
        ...
        crate::events::emit_plugin_deactivated(plugin_id);
    ...
    pub async fn unload_plugin(&self, plugin_id: &str) -> Result<(), CoreError> {
        ...
        if plugin_map.remove(plugin_id).is_some() {
            ...
            crate::events::emit_plugin_unloaded(plugin_id);
        }
