...
impl SqlDialect {
    fn to_engine_dialect(&self) -> crate::sql::SqlDialect {
        match self {
            SqlDialect::Generic => crate::sql::SqlDialect::Ansi,
            SqlDialect::Mysql => crate::sql::SqlDialect::Mysql,
            SqlDialect::Postgres => crate::sql::SqlDialect::Postgres,
            SqlDialect::Sqlite => crate::sql::SqlDialect::Sqlite,
            SqlDialect::Duckdb => crate::sql::SqlDialect::Duckdb,
            SqlDialect::MsSQL => crate::sql::SqlDialect::MsSQL,
            SqlDialect::Oracle => crate::sql::SqlDialect::Oracle,
            SqlDialect::Snowflake => crate::sql::SqlDialect::Snowflake,
            SqlDialect::BigQuery => crate::sql::SqlDialect::BigQuery,
            SqlDialect::Redshift => crate::sql::SqlDialect::Redshift,
        }
    }
}
