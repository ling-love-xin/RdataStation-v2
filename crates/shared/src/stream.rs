use crate::arrow::ArrowBatch;

/// 通用流式 trait
#[async_trait::async_trait]
pub trait Stream: Send + Sync {
    /// 尝试获取下一个批次
    async fn next(&mut self) -> Option<Result<ArrowBatch, crate::error::CoreError>>;
...
pub struct ArrowBatchStream {
    receiver: tokio::sync::mpsc::Receiver<Result<ArrowBatch, crate::error::CoreError>>,
}
